...
SRC += $(DIR_SRC)/map/reader.c
SRC += $(DIR_SRC)/map/writer.c
SRC += $(DIR_SRC)/fileReader.c
SRC += $(DIR_SRC)/solver.c

SRC_TEST += $(DIR_TEST)/map/reader.c
SRC_TEST += $(DIR_TEST)/map/writer.c
SRC_TEST += $(DIR_TEST)/tests/malloc.c
SRC_TEST += $(DIR_TEST)/tests/open.c
SRC_TEST += $(DIR_TEST)/tests/read.c
SRC_TEST += $(DIR_TEST)/fileReader.c
SRC_TEST += $(DIR_TEST)/solver.c

SRC_BONUS += $(DIR_BONUS)/map/writer.c
...
$(NAME): $(OBJ)
	@ gcc -o $(NAME) $(LDFLAGS) $(OBJ) && echo -n "\033[92m[ OK ]\033[0m" || echo -n "\033[91m[ ERROR ]\033[0m"
	@ echo "" $(NAME)

.PHONY: bonus
bonus: fclean $(OBJ_BONUS)
	@ gcc -o $(NAME) $(LDFLAGS) $(OBJ_BONUS) && echo -n "\033[92m[ OK ]\033[0m" || echo -n "\033[91m[ ERROR ]\033[0m"
	@ echo "" $(NAME)
...
$(NAME): $(OBJ)
	@ gcc -o $(NAME) $(LDFLAGS) $(OBJ) 1> /dev/null 2> /dev/null && echo -n "\033[92m[ OK ]\033[0m" || echo -n "\033[91m[ ERROR ]\033[0m"
	@ echo "" $(NAME)

.PHONY: bonus
bonus: fclean $(OBJ_BONUS)
	@ gcc -o $(NAME) $(LDFLAGS) $(OBJ_BONUS) 1> /dev/null 2> /dev/null && echo -n "\033[92m[ OK ]\033[0m" || echo -n "\033[91m[ ERROR ]\033[0m"
	@ echo "" $(NAME)
